                    ...
                    <form method="POST" action="/products/{{ $product->id }}" enctype="multipart/form-data"
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name"
                                ...
                                placeholder="Laptop DELL XPS" value="{{ $product->name }}">
                            @error('name')
                        ...
                        <div>
                            ...
                            <input type="text" name="price" id="price"
                                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="$100.00" value="{{ $product->price }}">
                            @error('price')
                                <div class="bg-red-500 p-1 text-white">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="file" name="product_image" id="product_image"
                                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <img alt="Product image" width="150" height="150"
                        ...
                        <button type="submit"
                            class="w-full text-white text-lg font-extrabold bg-red-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Delete
                            product
                        </button>
                    </form>
                </div>
